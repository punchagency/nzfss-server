...
import { CreateRulesInput, FindRulesByIdInput, RulesModel, UpdateRulesInput } from "../schema/rules.schema";
...
export class RulesService {
  ...
  async getAllRules(user: User | null) {
    try {
      ...
      // Fetch rules for all users, including guests
