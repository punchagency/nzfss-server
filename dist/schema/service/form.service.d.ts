...
import { CreateFormInput, FindFormByIdInput, Form, UpdateFormInput } from "../form.schema";
export declare class FormService {
    createForm(input: CreateFormInput, user: User): Promise<Form>;
    getAllForms(user: User): Promise<(import("mongoose").FlattenMaps<{
        _id: string;
        formName: string;
        formType: string;
        file?: string;
    ...
    deleteForm(user: User, formId: String): Promise<ApolloError | (import("mongoose").FlattenMaps<{
        _id: string;
        formName: string;
        formType: string;
        file?: string;
