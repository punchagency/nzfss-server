...
import { CreateEventCalendarInput, EventCalendar, FindEventCalendarByIdInput, UpdateEventCalendarInput } from "../calendar.schema";
export declare class CalendarService {
    createCalendar(input: CreateEventCalendarInput): Promise<EventCalendar>;
    getAllCalendarEvents(user: User): Promise<any>;
    findEventCalendarById(input: FindEventCalendarByIdInput, user: User): Promise<import("mongoose").FlattenMaps<{
        _id: string;
        ...
        public: boolean;
        isSubmitted: boolean;
        status: import("../calendar.schema").Status;
        eventName: string;
        eventDate: string;
        club: string;
        region: string;
