...
import { CreateUserInput, FindUserByIdInput, LoginInput, UpdateUserInput, User, UserRole } from "../schema/user.schema";
import Context from "../types/context";
declare class UserService {
    constructor();
    private fixUsersWithNullNames;
    ...
    findUserById(input: FindUserByIdInput, currentUser: User | undefined): Promise<(import("mongoose").FlattenMaps<{
        _id: string;
        name: string;
        email: string;
        password: string;
    ...
    findClubById(input: FindUserByIdInput, currentUser: User | undefined): Promise<import("mongoose").FlattenMaps<{
        _id: string;
        name: string;
        email: string;
        password: string;
    ...
    getAllUsers(user: User | undefined): Promise<(import("mongoose").FlattenMaps<{
        _id: string;
        name: string;
        email: string;
        password: string;
    ...
    getAllClubs(user: User | undefined): Promise<User[]>;
